...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A customer has scheduled a new appointment..create': {
    roles: ['owner', 'administrator', 'medical-staff', 'employee'],
    key: 'appointment_create',
    tenantPath: [],
    userPath: [],
  },
  'A medical record has been updated..update': {
    roles: ['owner', 'administrator', 'medical-staff'],
    key: 'medical_record_update',
    tenantPath: [],
    userPath: [],
  },
  'The inventory has been updated..update': {
...
const tenantRoles: string[] = ['owner', 'administrator', 'medical-staff', 'employee'];
